...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const merkurUndersideSection =
    document.getElementsByClassName("merkurUnderside")[0];
  ...
  const venusUndersideSection =
    document.getElementsByClassName("undersideVenus")[0];
  ...
  const jordenUndersideSection =
    document.getElementsByClassName("undersideJorden")[0];
  ...
  const marsUndersideSection =
    document.getElementsByClassName("undersideMars")[0];
  ...
  const jupiterUndersideSection =
    document.getElementsByClassName("undersideJupiter")[0];
  ...
  const saturnUndersideSection =
    document.getElementsByClassName("undersideSaturn")[0];
  ...
  const undersideUranusSection =
    document.getElementsByClassName("undersideUranus")[0];
  ...
  const undersideNeptuneSection =
    document.getElementsByClassName("undersideNeptune")[0];
